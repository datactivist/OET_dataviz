...
line_length_country <- read_csv("./data/api/line_length_growth_table2.csv")
```
...
output$plot7.2 <- renderPlotly({
  ...
  graph <- selected_process_data() |> 
    ...
    coord_flip() +
    labs(y = "Number of mappers", title = "Countries with the highest number of mappers") +
    theme_custom() +
    theme(panel.grid.major.x = ggplot2::element_blank(),
          panel.grid.major.y = ggplot2::element_blank(),
          plot.title.position = "plot",
...
output$plot9.2 <- renderPlotly({
  ...
  graph <- selected_process_data() |> 
    ...
    scale_x_discrete(labels = function(x) stringr::str_wrap(x, width = 30)) + 
    coord_flip() +
    labs(y = "Number of contributions", title = "Countries with the highest number of mappers") +
    theme_custom() +
    theme(panel.grid.major.x = ggplot2::element_blank(),
          panel.grid.major.y = ggplot2::element_blank(),
          plot.title.position = "plot",
...
since "début project"
inverser measure et temps (à gauche)
