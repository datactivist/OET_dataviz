...
output$plot8.0.2 <- renderPlotly({
    ...
    if (nrow(selected_circuits_data()) == 0) {
    # Créer un plotly vide avec message
    plot_ly() |>
      layout(
        xaxis = list(showgrid = FALSE, showticklabels = FALSE, zeroline = FALSE),
...
output$plot7.2 <- renderPlotly({
      ...
      if (nrow(selected_line_data()) == 0 | all(is.na(selected_line_data()$val))) {
    # Créer un plotly vide avec message
    plot_ly() |>
      layout(
        xaxis = list(showgrid = FALSE, showticklabels = FALSE, zeroline = FALSE),
...
output$plot8.2 <- renderPlotly({
  ...
  if (nrow(selected_substation_data()) == 0 | all(is.na(selected_substation_data()$val))) {
    # Créer un plotly vide avec message
    plot_ly() |>
      layout(
        xaxis = list(showgrid = FALSE, showticklabels = FALSE, zeroline = FALSE),
...
output$plot9.2 <- renderPlotly({
  ...
  if (nrow(selected_pylon_data()) == 0 | all(is.na(selected_pylon_data()$val))) {
    # Créer un plotly vide avec message
    plot_ly() |>
      layout(
        xaxis = list(showgrid = FALSE, showticklabels = FALSE, zeroline = FALSE),
