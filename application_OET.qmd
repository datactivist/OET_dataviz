...
value_world_supports_24H <- reactive({
  value_world_supports() |> 
    arrange(x) |> 
    slice_tail(n = 2) |> 
    mutate(growth_rate = round((amount - lag(amount)) / amount *100, 2),
...
value_world_supports_month1 <- reactive({
  value_world_supports() |> 
    arrange(x) |> 
    filter(x == max(x) | 
             x == as.Date(paste0(format(max(x), "%Y-%m"), "-01"))) |> 
...
output$n1_complete <- renderUI({
  tags$div(tags$div(style = "font-size: 1.2em;", 
    ...
    tags$div(style = "font-size: 0.5em; margin-top: 12px; opacity: 0.9;",
             tags$div(HTML("Last 24h : &nbsp;&nbsp;"), tags$span(style = "font-size: 1.5em;",
                                                                 value_world_circuits_24H()$amount),
                      if(value_world_circuits_24H()$growth_rate >= 0) { 
                        tags$span(style = "color: #90EE90;", "▲")
                      } else {
                        tags$span(style = "color: #FC4B3D;", "▼")
                        },
                      ifelse(value_world_circuits_24H()$growth_rate >= 0, 
                             paste0("+", value_world_circuits_24H()$growth_rate, "%"), 
                             paste0(value_world_circuits_24H()$growth_rate, "%"))),
             tags$div(style = "margin-top: 2px;",
                      "Month 1st :", tags$span(style = "font-size: 1.5em;", 
                                               value_world_circuits_month1()$amount),
                      if(value_world_circuits_month1()$growth_rate >= 0) { 
                        tags$span(style = "color: #90EE90;", "▲")
                      } else {
                        tags$span(style = "color: #FC4B3D;", "▼")
                        },
                      ifelse(value_world_circuits_month1()$growth_rate >= 0, 
...
output$n2_complete <- renderUI({
  tags$div(tags$div(style = "font-size: 1.2em;", 
    ...
    tags$div(style = "font-size: 0.5em; margin-top: 12px; opacity: 0.9;",
             tags$div(HTML("Last 24h : &nbsp;&nbsp;"), tags$span(style = "font-size: 1.5em;",
                                                                 value_world_lines_24H()$amount),
                      if(value_world_lines_24H()$growth_rate >= 0) { 
                        tags$span(style = "color: #90EE90;", "▲")
                      } else {
                        tags$span(style = "color: #FC4B3D;", "▼")
                        },
                      ifelse(value_world_lines_24H()$growth_rate >= 0, 
                             paste0("+", value_world_lines_24H()$growth_rate, "%"), 
                             paste0(value_world_lines_24H()$growth_rate, "%"))),
             tags$div(style = "margin-top: 2px;",
                      "Month 1st :", tags$span(style = "font-size: 1.5em;", 
                                               value_world_lines_month1()$amount),
                      if(value_world_lines_month1()$growth_rate >= 0) { 
                        tags$span(style = "color: #90EE90;", "▲")
                      } else {
                        tags$span(style = "color: #FC4B3D;", "▼")
                        },
                      ifelse(value_world_lines_month1()$growth_rate >= 0, 
...
output$n3_complete <- renderUI({
  tags$div(tags$div(style = "font-size: 1.2em;", 
    ...
    tags$div(style = "font-size: 0.5em; margin-top: 12px; opacity: 0.9;",
             tags$div(HTML("Last 24h : &nbsp;&nbsp;"), tags$span(style = "font-size: 1.5em;",
                                                                 value_world_substations_24H()$amount),
                      if(value_world_substations_24H()$growth_rate >= 0) { 
                        tags$span(style = "color: #90EE90;", "▲")
                      } else {
                        tags$span(style = "color: #FC4B3D;", "▼")
                        },
                      ifelse(value_world_substations_24H()$growth_rate >= 0, 
                             paste0("+", value_world_substations_24H()$growth_rate, "%"), 
                             paste0(value_world_substations_24H()$growth_rate, "%"))),
             tags$div(style = "margin-top: 2px;",
                      "Month 1st :", tags$span(style = "font-size: 1.5em;", 
                                               value_world_substations_month1()$amount),
                      if(value_world_substations_month1()$growth_rate >= 0) { 
                        tags$span(style = "color: #90EE90;", "▲")
                      } else {
                        tags$span(style = "color: #FC4B3D;", "▼")
                        },
                      ifelse(value_world_substations_month1()$growth_rate >= 0, 
...
output$n4_complete <- renderUI({
  tags$div(tags$div(style = "font-size: 1.2em;", 
    ...
    tags$div(style = "font-size: 0.5em; margin-top: 12px; opacity: 0.9;",
             tags$div(HTML("Last 24h : &nbsp;&nbsp;"), tags$span(style = "font-size: 1.5em;",
                                                                 value_world_supports_24H()$amount),
                      if(value_world_supports_24H()$growth_rate >= 0) { 
                        tags$span(style = "color: #90EE90;", "▲")
                      } else {
                        tags$span(style = "color: #FC4B3D;", "▼")
                        },
                      ifelse(value_world_supports_24H()$growth_rate >= 0, 
                             paste0("+", value_world_supports_24H()$growth_rate, "%"), 
                             paste0(value_world_supports_24H()$growth_rate, "%"))),
             tags$div(style = "margin-top: 2px;",
                      "Month 1st :", tags$span(style = "font-size: 1.5em;", 
                                               value_world_supports_month1()$amount),
                      if(value_world_supports_month1()$growth_rate >= 0) { 
                        tags$span(style = "color: #90EE90;", "▲")
                      } else {
                        tags$span(style = "color: #FC4B3D;", "▼")
                        },
                      ifelse(value_world_supports_month1()$growth_rate >= 0, 
                             paste0("+", value_world_supports_month1()$growth_rate, "%"), 
                             paste0(value_world_supports_month1()$growth_rate, "%")))))
})
```
...
output$n1_complete_length <- renderUI({
  tags$div(tags$div(style = "font-size: 1.2em;", 
    ...
    tags$div(style = "font-size: 0.5em; margin-top: 12px; opacity: 0.9;",
             tags$div(HTML("Last 24h : &nbsp;&nbsp;"), tags$span(style = "font-size: 1.5em;",
                                                                 value_world_circuits_24H_length()$length),
                      if (value_world_circuits_24H_length()$growth_rate >= 0) { 
                        tags$span(style = "color: #90EE90;", "▲")
                      } else {
                          if (value_world_circuits_24H_length()$growth_rate == 0) {
                          tags$span(style = "color: #F78865;", "EGA")
                        } else {
                          tags$span(style = "color: #FC4B3D;", "▼")
                        }},
                      ifelse(value_world_circuits_24H_length()$growth_rate >= 0,
             ...
             tags$div(style = "margin-top: 2px;",
                      "Month 1st :", tags$span(style = "font-size: 1.5em;", 
                                               value_world_circuits_month1_length()$length),
                      if(value_world_circuits_month1_length()$growth_rate >= 0) { 
                        tags$span(style = "color: #90EE90;", "▲")
                      } else {
                        tags$span(style = "color: #FC4B3D;", "▼")
                        },
                      ifelse(value_world_circuits_month1_length()$growth_rate >= 0, 
...
output$n2_complete_length <- renderUI({
  tags$div(tags$div(style = "font-size: 1.2em;", 
    ...
    tags$div(style = "font-size: 0.5em; margin-top: 12px; opacity: 0.9;",
             tags$div(HTML("Last 24h : &nbsp;&nbsp;"), tags$span(style = "font-size: 1.5em;",
                                                                 value_world_lines_24H_length()$length),
                      if(value_world_lines_24H_length()$growth_rate >= 0) { 
                        tags$span(style = "color: #90EE90;", "▲")
                      } else {
                        tags$span(style = "color: #FC4B3D;", "▼")
                        },
                      ifelse(value_world_lines_24H_length()$growth_rate >= 0, 
                             paste0("+", value_world_lines_24H_length()$growth_rate, "%"), 
                             paste0(value_world_lines_24H_length()$growth_rate, "%"))),
             tags$div(style = "margin-top: 2px;",
                      "Month 1st :", tags$span(style = "font-size: 1.5em;", 
                                               value_world_lines_month1_length()$length),
                      if(value_world_lines_month1_length()$growth_rate >= 0) { 
                        tags$span(style = "color: #90EE90;", "▲")
                      } else {
                        tags$span(style = "color: #FC4B3D;", "▼")
                        },
                      ifelse(value_world_lines_month1_length()$growth_rate >= 0, 
...
output$n3_complete_length <- renderUI({
  tags$div(tags$div(style = "font-size: 1.2em;", 
    ...
    tags$div(style = "font-size: 0.5em; margin-top: 12px; opacity: 0.9;",
             tags$div(HTML("Last 24h : &nbsp;&nbsp;"), tags$span(style = "font-size: 1.5em;",
                                                                 value_world_substations_24H_length()$area),
                      if(value_world_substations_24H_length()$growth_rate >= 0) { 
                        tags$span(style = "color: #90EE90;", "▲")
                      } else {
                        tags$span(style = "color: #FC4B3D;", "▼")
                        },
                      ifelse(value_world_substations_24H_length()$growth_rate >= 0, 
                             paste0("+", value_world_substations_24H_length()$growth_rate, "%"), 
                             paste0(value_world_substations_24H_length()$growth_rate, "%"))),
             tags$div(style = "margin-top: 2px;",
                      "Month 1st :", tags$span(style = "font-size: 1.5em;", 
                                               value_world_substations_month1_length()$area),
                      if(value_world_substations_month1_length()$growth_rate >= 0) { 
                        tags$span(style = "color: #90EE90;", "▲")
                      } else {
                        tags$span(style = "color: #FC4B3D;", "▼")
                        },
                      ifelse(value_world_substations_month1_length()$growth_rate >= 0, 
...
value_world_pylons_24H <- reactive({
  mappers_pylons_period() |> 
    arrange(x) |> 
    slice_tail(n = 2) |> 
    mutate(growth_rate = round((val - lag(val)) / val *100, 2),
...
value_world_pylons_month1 <- reactive({
  mappers_pylons_period() |> 
    arrange(x) |> 
    filter(x == max(x) | 
             x == as.Date(paste0(format(max(x), "%Y-%m"), "-01"))) |> 
...
```{r}
#| context: server
#| label: display 4 valuebox mappers
...
output$n5.0_complete <- renderUI({
  tags$div(tags$div(style = "font-size: 1.2em;", 
    ...
    tags$div(style = "font-size: 0.5em; margin-top: 12px; opacity: 0.9;",
             tags$div(HTML("Last 24h : &nbsp;&nbsp;"), tags$span(style = "font-size: 1.5em;",
                                                                 value_world_circuits_24H()$val),
                      if (value_world_circuits_24H()$growth_rate >= 0) { 
                        tags$span(style = "color: #90EE90;", "▲")
                      } else {
                          if (value_world_circuits_24H()$growth_rate == 0) {
                          tags$span(style = "color: #F78865;", "=")
                        } else {
                          tags$span(style = "color: #FC4B3D;", "▼")
                        }},
                      ifelse(value_world_circuits_24H()$growth_rate >= 0,
             ...
             tags$div(style = "margin-top: 2px;",
                      "Month 1st :", tags$span(style = "font-size: 1.5em;", 
                                               value_world_circuits_month1()$val),
                      if(value_world_circuits_month1()$growth_rate >= 0) { 
                        tags$span(style = "color: #90EE90;", "▲")
                      } else {
                        tags$span(style = "color: #FC4B3D;", "▼")
...
output$n6_complete <- renderUI({
  tags$div(tags$div(style = "font-size: 1.2em;", 
    ...
    tags$div(style = "font-size: 0.5em; margin-top: 12px; opacity: 0.9;",
             tags$div(HTML("Last 24h : &nbsp;&nbsp;"), tags$span(style = "font-size: 1.5em;",
                                                                 value_world_substations_24H()$val),
                      if (value_world_substations_24H()$growth_rate >= 0) { 
                        tags$span(style = "color: #90EE90;", "▲")
                      } else {
                          if (value_world_substations_24H()$growth_rate == 0) {
             ...
             tags$div(style = "margin-top: 2px;",
                      "Month 1st :", tags$span(style = "font-size: 1.5em;", 
                                               value_world_substations_month1()$val),
                      if(value_world_substations_month1()$growth_rate >= 0) { 
                        tags$span(style = "color: #90EE90;", "▲")
                      } else {
                        tags$span(style = "color: #FC4B3D;", "▼")
...
output$n7_complete <- renderUI({
  tags$div(tags$div(style = "font-size: 1.2em;", 
    ...
    tags$div(style = "font-size: 0.5em; margin-top: 12px; opacity: 0.9;",
             tags$div(HTML("Last 24h : &nbsp;&nbsp;"), tags$span(style = "font-size: 1.5em;",
                                                                 value_world_pylons_24H()$val),
                      if (value_world_pylons_24H()$growth_rate >= 0) { 
                        tags$span(style = "color: #90EE90;", "▲")
                      } else {
                          if (value_world_pylons_24H()$growth_rate == 0) {
                          tags$span(style = "color: #F78865;", "=")
                      ...
                      ifelse(value_world_pylons_24H()$growth_rate >= 0,
                             paste0("+", value_world_pylons_24H()$growth_rate, "%"), 
                             ifelse(value_world_pylons_24H()$growth_rate < 0,
                                    paste0(value_world_pylons_24H()$growth_rate, "%"),
                                    ""))),
             tags$div(style = "margin-top: 2px;",
                      "Month 1st :", tags$span(style = "font-size: 1.5em;", 
                                               value_world_pylons_month1()$val),
                      if(value_world_pylons_month1()$growth_rate >= 0) { 
                        tags$span(style = "color: #90EE90;", "▲")
                      } else {
                        tags$span(style = "color: #FC4B3D;", "▼")
                        },
                      ifelse(value_world_pylons_month1()$growth_rate >= 0, 
                             paste0("+", value_world_pylons_month1()$growth_rate, "%"), 
                             paste0(value_world_pylons_month1()$growth_rate, "%")))))
})
```
