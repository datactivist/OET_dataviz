...
output$n4_complete <- renderUI({
  ...
  if (value_world_supports_last()$amount == "NA") { #on n'affiche rien qd df vide (sinon error affichée)
    "" } else {
  ...
  tags$div(tags$div(style = "font-size: 1.2em;", 
    ...
    tags$div(style = "font-size: 0.5em; margin-top: 12px; opacity: 0.9;",
             tags$div(tags$img(src = "images/myg_24h.svg", 
                               style = "height: 25px; vertical-align: top; margin-right: 5px; filter: brightness(0) invert(1);"), 
                      tags$span(style = "font-size: 1.5em;", value_world_supports_24H()$amount),
                      if(value_world_supports_last()$amount > value_world_supports_24H()$amount) {
                        tagList(tags$span(style = "color: #90EE90;", "▲"), 
                                paste0("+", value_world_supports_24H()$growth_rate, "%"))
                        } else if(value_world_supports_last()$amount < value_world_supports_24H()$amount) {
                          tagList(tags$span(style = "color: #FC4B3D;", "▼"),
                                  paste0(value_world_supports_24H()$growth_rate, "%"))
                          } else {
                            tags$span(style = "color: #FFA500;", "=") 
             ...
             tags$div(style = "margin-top: 2px;",
                      tags$img(src = "images/myg_1m.svg", 
                               style = "height: 25px; vertical-align: top; margin-right: 5px; filter: brightness(0) invert(1);"), 
                      tags$span(style = "font-size: 1.5em;", value_world_supports_month1()$amount),
                      if(value_world_supports_last()$amount > value_world_supports_month1()$amount) {
                        tagList(tags$span(style = "color: #90EE90;", "▲"),
                                paste0("+", value_world_supports_month1()$growth_rate, "%"))
                        } else if(value_world_supports_last()$amount < value_world_supports_month1()$amount) {
                          tagList(tags$span(style = "color: #FC4B3D;", "▼"),
                                  paste0(value_world_supports_month1()$growth_rate, "%"))
                          } else {
                            tags$span(style = "color: #FFA500;", "=")
...
mappers_world_pylons_24H <- reactive({
  mappers_pylons_period() |> 
    arrange(x) |> 
    slice_tail(n = 2) |> 
    mutate(growth_rate = round((val - lag(val)) / val *100, 2),
...
mappers_world_pylons_month1 <- reactive({
  mappers_pylons_period() |> 
    arrange(x) |> 
    filter(x == max(x) | 
             x == as.Date(paste0(format(max(x), "%Y-%m"), "-01"))) |> 
  ...
  tags$div(tags$div(style = "font-size: 1.2em;", 
    ...
    tags$div(style = "font-size: 0.5em; margin-top: 12px; opacity: 0.9;",
             tags$div(tags$img(src = "images/myg_24h.svg",                                 
                      ...
                      if (mappers_world_circuits_24H()$growth_rate >= 0) { 
                      ...
                      ifelse(mappers_world_circuits_24H()$growth_rate >= 0,
             ...
             tags$div(style = "margin-top: 2px;",
                      ...
                      if(mappers_world_circuits_month1()$growth_rate >= 0) { 
                        tags$span(style = "color: #90EE90;", "▲")
                      } else {
                        tags$span(style = "color: #FC4B3D;", "▼")
                        },
                      ifelse(mappers_world_circuits_month1()$growth_rate >= 0, 
  ...
  tags$div(tags$div(style = "font-size: 1.2em;", 
    ...
    tags$div(style = "font-size: 0.5em; margin-top: 12px; opacity: 0.9;",
             tags$div(tags$img(src = "images/myg_24h.svg",                                 
                      ...
                      if (mappers_world_lines_24H()$growth_rate >= 0) { 
                        tags$span(style = "color: #90EE90;", "▲")
                      } else {
                          if (mappers_world_lines_24H()$growth_rate == 0) {
                          tags$span(style = "color: #F78865;", "=")
                      ...
                      ifelse(mappers_world_lines_24H()$growth_rate >= 0,
             ...
             tags$div(style = "margin-top: 2px;",
                      ...
                      if(mappers_world_lines_month1()$growth_rate >= 0) { 
                        tags$span(style = "color: #90EE90;", "▲")
                      } else {
                        tags$span(style = "color: #FC4B3D;", "▼")
                        },
                      ifelse(mappers_world_lines_month1()$growth_rate >= 0, 
  ...
  tags$div(tags$div(style = "font-size: 1.2em;", 
    ...
    tags$div(style = "font-size: 0.5em; margin-top: 12px; opacity: 0.9;",
             tags$div(tags$img(src = "images/myg_24h.svg",                                 
                      ...
                      if (mappers_world_substations_24H()$growth_rate >= 0) { 
                        tags$span(style = "color: #90EE90;", "▲")
                      } else {
                          if (mappers_world_substations_24H()$growth_rate == 0) {
                          tags$span(style = "color: #F78865;", "=")
                      ...
                      ifelse(mappers_world_substations_24H()$growth_rate >= 0,
             ...
             tags$div(style = "margin-top: 2px;",
                      ...
                      if(mappers_world_substations_month1()$growth_rate >= 0) { 
                        tags$span(style = "color: #90EE90;", "▲")
                      } else {
                        tags$span(style = "color: #FC4B3D;", "▼")
                        },
                      ifelse(mappers_world_substations_month1()$growth_rate >= 0, 
...
output$n7_complete <- renderUI({
  ...
  if (mappers_pylons_period_last()$val == "NA") { #on n'affiche rien qd df vide (sinon error affichée)
    "" } else {
  ...
  tags$div(tags$div(style = "font-size: 1.2em;", 
    ...
    tags$div(style = "font-size: 0.5em; margin-top: 12px; opacity: 0.9;",
             tags$div(tags$img(src = "images/myg_24h.svg",                                 
                               style = "height: 25px; vertical-align: top; margin-right: 5px; filter: brightness(0) invert(1);"), 
                      tags$span(style = "font-size: 1.5em;", mappers_world_pylons_24H()$val),
                      if (mappers_world_pylons_24H()$growth_rate >= 0) { 
                        tags$span(style = "color: #90EE90;", "▲")
                      } else {
                          if (mappers_world_pylons_24H()$growth_rate == 0) {
                          tags$span(style = "color: #F78865;", "=")
                      ...
                      ifelse(mappers_world_pylons_24H()$growth_rate >= 0,
                             paste0("+", mappers_world_pylons_24H()$growth_rate, "%"), 
                             ifelse(mappers_world_pylons_24H()$growth_rate < 0,
                                    paste0(mappers_world_pylons_24H()$growth_rate, "%"),
                                    ""))),
             tags$div(style = "margin-top: 2px;",
                      tags$img(src = "images/myg_1m.svg",                                 
                               style = "height: 25px; vertical-align: top; margin-right: 5px; filter: brightness(0) invert(1);"), 
                      tags$span(style = "font-size: 1.5em;", mappers_world_pylons_month1()$val),
                      if(mappers_world_pylons_month1()$growth_rate >= 0) { 
                        tags$span(style = "color: #90EE90;", "▲")
                      } else {
                        tags$span(style = "color: #FC4B3D;", "▼")
                        },
                      ifelse(mappers_world_pylons_month1()$growth_rate >= 0, 
                             paste0("+", mappers_world_pylons_month1()$growth_rate, "%"), 
                             paste0(mappers_world_pylons_month1()$growth_rate, "%")))))
    }
})
```
